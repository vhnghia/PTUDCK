...
public class GiaoDienAdmin extends JFrame implements ActionListener,MouseListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource().equals(menuIDoiMatKhauSV)) {
			GiaoDienCapNhatMatKhau gdcnmksv = new GiaoDienCapNhatMatKhau();
			gdcnmksv.setVisible(true);
			dispose();
		}
